...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        choices=[0, 16],
        default=16,
        help="BFP exponent tile size; 0 keeps the legacy one-exponent-per-front mode",
    )
    parser.add_argument(
        "--equilibrate",
        choices=["none", "pow2-row", "pow2-row-column", "pow2-ruiz"],
        default="pow2-row-column",
    ...
    parser.add_argument(
        ...
        type=int,
        default=4,
        help="alternating row/column normalization passes",
    )
